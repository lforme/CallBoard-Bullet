//
//  SpeedCVDelegateViewModel.swift
//  CallBoard
//
...
class SpeedCVDelegateViewModel: NSObject {
...
extension SpeedCVDelegateViewModel: UICollectionViewDataSource {
...
extension SpeedCVDelegateViewModel: UICollectionViewDelegate {
