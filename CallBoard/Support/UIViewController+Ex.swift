...
extension UIViewController {
    ...
    @discardableResult
    func createdRightNavigationItem(title: String?, font: UIFont? = UIFont.boldSystemFont(ofSize: 16), image: UIImage?, rightEdge: CGFloat = 10, color: UIColor = UIColor.flatWhite) -> UIButton {
